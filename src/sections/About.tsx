...
export default function About() {
  return (
    <div className="w-[95%] mx-auto bg-[#ffffff] shadow-md border-l-4 border-[#4F46E5] rounded p-5 flex flex-col gap-3">
      ...
      <p className="sm:text-lg text-md text-justify font-light">
        I'm <span className="text-[#4F46E5] font-medium">Samroon Jesper</span>,
        a passionate{" "}
        ...
        and tools like <span className="text-[#4F46E5] font-medium">Axios</span>{" "}
        ...
        <span className="text-[#4F46E5] font-medium">React DevTools,</span> I
